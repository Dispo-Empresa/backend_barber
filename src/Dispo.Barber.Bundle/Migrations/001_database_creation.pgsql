...
CREATE TABLE public."BusinessUnities" (
    "Id" BIGINT GENERATED BY DEFAULT AS IDENTITY (INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
    "CNPJ" TEXT NULL,
    "Phone" TEXT NULL,
...
CREATE INDEX "IX_BusinessUnities_CompanyId" ON public."BusinessUnities" ("CompanyId");
...
CREATE INDEX "IX_CompanyServices_ServiceId" ON public."CompanyServices" USING btree ("ServiceId");
...
CREATE INDEX "IX_Users_BusinessUnityId" ON public."Users" USING btree ("BusinessUnityId");
...
CREATE TABLE public."Appointments" (
	...
	CONSTRAINT "FK_Appointments_Services_ServiceId" FOREIGN KEY ("ServiceId") REFERENCES public."Services"("Id") ON DELETE CASCADE,
	CONSTRAINT "FK_Appointments_Users_AcceptedUserId" FOREIGN KEY ("AcceptedUserId") REFERENCES public."Users"("Id")
);
CREATE INDEX "IX_Appointments_AcceptedUserId" ON public."Appointments" USING btree ("AcceptedUserId");
CREATE INDEX "IX_Appointments_BusinessUnityId" ON public."Appointments" USING btree ("BusinessUnityId");
...
CREATE TABLE public."UserSchedules" (
	"Id" bigint GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE INDEX "IX_UserSchedules_UserId" ON public."UserSchedules" USING btree ("UserId");
...
CREATE TABLE public."MigrationManager"