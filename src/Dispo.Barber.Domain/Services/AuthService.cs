...
{
    public class AuthService(IUserRepository userRepository, ITokenRepository tokenRepository, IMemoryCache cache) : IAuthService
    {
        ...
        public async Task<AuthenticationResult> AuthenticateAsync(CancellationToken cancellationToken, string phone, string password)
        {
            ...
            return BuildAuthenticationResult(user, refreshToken);
        }
        ...
        private AuthenticationResult BuildAuthenticationResult(User user, string refreshToken)
        {
